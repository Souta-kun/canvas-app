...
export function CardModal({
  ...
  return (
    <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogContent className="sm:max-w-lg md:max-w-2xl max-h-[85vh] overflow-y-auto kanban-scrollbar">
        <DialogHeader>
        ...
        <Tabs defaultValue="details" className="space-y-4">
          <TabsList className="grid w-full grid-cols-2">
            ...
            <TabsTrigger value="subtasks">Subtareas ({completed}/{total})</TabsTrigger>
          </TabsList>
